...
import BAM.client.BAMAgentClassLoader;
import BAM.client._Agent;
...
public final class Server implements _Server{
	...
	public Server(final int port, final String name){
		...
		try {
			...
			agentServer = new AgentServer(port, "aze");
	...
	public final void addService(String name, String classeName, String codeBase, Object... args) {
		try {
		    ...
		    Constructor<?> constructeur = classe.getConstructor(Object[].class);
		    constructeur.newInstance(args);
		}catch(Exception ex){
			logger.log(Level.FINE," erreur durant le lancement du serveur"+this,ex);
			return;
		}
